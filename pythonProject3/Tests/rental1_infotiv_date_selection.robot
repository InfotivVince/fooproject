...
User can make own input in date-boxes
    ...
    Go to Web Page
    Verify Page Loaded
    Click Button DateLeft       0301
    Click Button DateRight      0302
    Click Button Continue
    Verify Access To Car Page
...
Use can't access car page if the booking are longer than 30 days.
    ...
    Go to Web Page
    Verify Page Loaded
    Click Button DateLeft       0228
    Click Button DateRight      0329
    Click Button Continue
    Verify Page Loaded
...
Use can't access car page if the start-date are more than 30 days in the future.
    ...
    Go to Web Page
    Verify Page Loaded
    Click Button DateLeft       0329
    Click Button DateRight      0330
    Click Button Continue
    Verify Page Loaded
